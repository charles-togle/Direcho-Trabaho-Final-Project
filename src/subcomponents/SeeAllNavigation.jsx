...
const SeeAllNavigation = ({ onLeftClick, onRightClick, showSeeAll = true }) => {
  return (
    <div className='flex items-center gap-2'>
      {showSeeAll && (
        <button className='text-white px-4 hover:underline font-bold cursor-pointer'>
          See All
        </button>
      )}
      ...
      <button
        onClick={onLeftClick}
        className='bg-base-shade rounded-full hover:bg-gray-700 w-10 h-10 flex items-center justify-center cursor-pointer'
      >
